...
<html lang="en">
    ...
    <body>
        ...
        <div class="section mt-5">
            <div class="container">
                <h3><b><i class="fas fa-box text-black-50"></i> Data Produk</b></h3>
                <table class="table table-success table-striped" >
                    ...
                    <tbody>
                        <?php
                            $no = 1;
                            $produk = mysqli_query($connect, "SELECT * FROM product LEFT JOIN category USING (category_id) ORDER BY product_id DESC");
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit-produk.php?id=<?php echo $row['product_id']; ?>" style="text-decoration:none;" class="text-dark">Edit</a> || <a href="
                                proses-hapus.php?idp=<?php echo $row['product_id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus ?')" style="text-decoration:none;" class="text-dark">Hapus</a>
                            </td>
                        </tr>
                        <?php }} else { ?>
                            <tr>
                ...
                <p><a href="tambah-produk.php" style="text-decoration:none;" class="text-white btn btn-primary btn-sm">Tambah Data</a></p>
            </div>
        </div>
